...
<div class="col-sm-6"> <h1 class="m-0">Purchase Add</h1> </div><!-- /.col -->
<div class="col-sm-6">
    ...
    <!-- Main row -->
    <div class="row">
        <div class="col-md-12"> <form action="{{route('backend.purchase.update',$purchase->id)}}" method="POST"
            enctype="multipart/form-data"> 
            @csrf 
            @method("PUT")
            <div class="card card-primary"> <div class="card-header"> <h3
            class="card-title">Purchase Edit</h3>
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                name="purchase_date" placeholder="Enter Purchase Date" required
            ...
            <select class="form-control select2" id="supplier_id" name="supplier_id" required>
                ...
                <option value="{{$supplier->id}}" @if(old('supplier_id',$purchase->supplier_id)==$supplier->id)
                    selected
        ...
        <input type="text" class="form-control" id="invoice_number" name="invoice_number" placeholder="Enter invoice
            number" value="{{old('invoice_number',$purchase->invoice_number)}}"> </div> </div>
        <div class="col-md-6">

        <div class="form-group">
            <label for="purchase_code">Purchase Code</label>
            <input type="text" class="form-control" id="purchase_code" name="purchase_code"
            placeholder="Enter purchase code" value="{{old('purchase_code',$purchase->purchase_code)}}">
            </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="card-body">
        ...
        <input type="text" class="form-control calculate_total" id="purchase_quantity" name="purchase_quantity"
            placeholder="Enter Purchase Quantity"> </div>
        </div>
        <div class="col-md-3">
        ...
        <textarea class="form-control" id="purchase_note" name="purchase_note" placeholder="Enter purchase
            note"></textarea> </div> </div>
                                        ...
                                        <tbody id="purchase_details">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <input type="hidden" name="serials[]"
                                                        value="{{($serial_data && count($serial_data)>0)?$serial_data:''}}">
                                                </td>
                                                <td> <a href="#" class=" btn btn-danger remove"> X </a></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" id="discount" name="discount"
                                value="{{old('discount',$purchase->discount)}}"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" readonly id="payable_amount"
                                name="payable_amount" value="{{old('payable_amount',$purchase->payable_amount)}}"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" id="paid_amount"
                                name="paid_amount" value="{{old('paid_amount',$purchase->paid_amount)}}"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" readonly id="due_amount"
                                name="due_amount" value="{{old('due_amount',$purchase->due_amount)}}">
                        </div>
                    </div>
                </div>
