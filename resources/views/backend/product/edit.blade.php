                    ...
                    <div class="row">
                        <div class="col-md 12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="code" name="code" placeholder="Enter Product COde" value="{{old('code',$product->code)}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="brand_id" name="brand_id" required>
                                    ...
                                    <option value="{{$brand->id}}" @if ($brand->id == old('brand_id',$product->brand_id)) selected @endif >{{$brand->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="unit_id" name="unit_id" required>
                                    ...
                                    <option value="{{$unit->id}}" @if ($unit->id == old('unit_id',$product->unit_id)) selected @endif >{{$unit->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="is_active" name="is_active" @if(old("is_active",$product->is_active)==1)checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Yes" data-off-text="No" value="1">
