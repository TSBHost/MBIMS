        ...
        <form action="{{route('backend.area.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card  card-primary">
                <div class="card-header">
                    <h3 class="card-title">Area Add New</h3>
                    ...
                    <div class="row">
                        <div class="col-md 12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Area Name" required value="{{old('name')}}">
                            </div>
