...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0">Area
            <a href="{{route('backend.area.create')}}" class="btn btn-success"><i class="fas fa-plus"></i> Add New</a>
        </h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card card-warning">
            ...
            <div class="card-body">
                <form method="get">
                    <div class="row mb-2">
                        <div class="col-md-3 text-right"><label>Search Area</label></div>
                        <div class="col-md-6">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('backend.area.edit',$area->id)}}" class="btn btn-icon btn-warning"><i class="fas fa-edit"></i></a>
                                <a href="" data-id="{{$area->id}}" data-url="{{route('backend.area.destroy',$area->id)}}" class="btn_delete btn btn-icon btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
