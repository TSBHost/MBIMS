            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    ...
                    @if(Route::currentRouteName() == 'backend.dashboard') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{route('logout')}}" class="nav-link text-danger text-bold" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
