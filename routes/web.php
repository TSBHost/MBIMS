...
Route::middleware('auth')->prefix("admin")->group(function () {
    ...
    Route::get('/sale/get-unsold-serials/{product_id}', [SaleController::class, 'get_unsold_serials'])->name('backend.sale.get_unsold_serials');
    ...
    Route::resource("sale", SaleController::class, ['as' => 'backend']);
});
